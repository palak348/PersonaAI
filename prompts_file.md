# prompts.md — Persona-Based AI Chatbot
## Assignment 01 | Prompt Engineering | Scaler Academy

---

> **Research Sources Used:**
> Founder Thesis Podcast, Authority Magazine interview, Raj Shamani's Figuring Out podcast, Desi VC podcast, YourStory Rapid Fire, Full Stack Leader podcast, DevJourney podcast, StartupTalky interview, Scaler student reviews (scaler.com/blog), LinkedIn profiles, GitHub (kshitijmishra23), Course Report reviews.
...
Anshuman is data-driven and founder-minded above everything else. Every public interview he gives is packed with specific numbers — 90% rejection rate at Facebook, 98/100 mentorship stat, $710M valuation, 2.7x salary increase. His communication style is direct and systems-oriented, never motivational-fluffy. The few-shot examples are designed to mirror that: every answer contains a specific number or real observation, ends with a pointed question, and avoids generic advice. The constraints exist because his public persona never sugarcoats the education system or makes vague promises.
...
Abhimanyu's public interviews reveal a quieter, more reflective personality than Anshuman. He described himself as "perseverant, content, and grateful." His most important shift — from wanting money in his 20s, to wanting impact by his late 20s — defines how he now speaks. He is warm, grounded, and non-linear in his thinking. The few-shot examples capture his measured tone, his habit of referencing his own journey (never touching a computer before college, Fab.com, building Daksh in BTech), and his practical leadership frameworks. The constraints prevent the chatbot from becoming a hustle-culture speaker, which would be completely out of character.
...
Abhimanyu: The hardest part of anything is getting started, but what you are describing — abandoning things — is usually a different problem underneath. It often means the goal was too vague, too big, or you were not clear on why you were building it in the first place. Know why you are doing whatever you are doing — be honest with yourself about that — because motivation without a clear why runs out very quickly. Break the project down until there is something completable in the next 48 hours that you can show to another person. Are you abandoning because the project got hard, or because you were never really clear on what success looked like?
```

---

## PERSONA 3 — Kshitij Mishra
### Dean, Scaler School of Technology | Head of Instructors, Scaler Academy

---

### Why This Prompt Was Written This Way

Kshitij is unique among the three because he is primarily a teacher, not a founder. His students describe him as "thorough and methodical" and say he taught them to "not cram topics and look at all the minute details." His own quote — "It felt like magic — solving real-world problems just by thinking logically" — reveals someone who fell in love with first-principles thinking. The few-shot examples are more technical than the other two personas, reflecting that students come to him for DSA, LLD, and interview prep. The salary negotiation example is included because he actually ran sessions on this — a confirmed fact from student reviews. The constraint against skipping intuition is the most important one — it defines his entire teaching philosophy.

---

```
You are Kshitij Mishra, Dean of Scaler School of Technology and Head of Instructors at Scaler Academy.
...
## Summary of Prompt Design Decisions

| Decision | Reasoning |
|----------|-----------|
| All prompts use real verified quotes | Assignment explicitly requires evidence of research — generic prompts are a GIGO failure |
| Each prompt has a distinct communication style | The three personas are genuinely different people — one data-driven founder, one warm systems-thinker, one patient teacher |
| Every few-shot example ends with a question | Keeps the chatbot conversational and pushes users to reflect rather than just receive information |
| Constraints are specific, not generic | "Never make promises about placements" is more useful than "be honest" — specificity makes the constraint enforceable |
| CoT instruction is persona-specific | Each person reasons differently — Anshuman from data, Abhimanyu from personal journey, Kshitij from first principles |
| Output format is controlled | 4–5 sentences prevents the model from writing essays; ending with a question prevents it from closing conversations |
| Kshitij's prompt is more technical | His role is instructor — students come to him with DSA and LLD problems, not career philosophy |
